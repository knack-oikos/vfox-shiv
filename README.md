...
[![shiv: v0.3.2](https://img.shields.io/badge/shiv-v0.3.2-blue?style=flat)](https://github.com/KnickKnackLabs/shiv)
...
mise install "shiv:shimmer@0.0.1-alpha"
  ...
  │
  ├─ BackendInstall
  │    ensure shiv is bootstrapped (pinned to v0.3.2)
...
The plugin maintains its own shiv clone at `~/.local/share/mise/shiv-backend/shiv/`, pinned to `v0.3.2` for reproducibility. This is separate from any user-installed shiv — the plugin's build infrastructure doesn't change unless you deliberately update it.
